...
linePlot_data <- linePlot_data[which((linePlot_data$target == 2) & (linePlot_data$bounType == 3) & (linePlot_data$TargPoinDis < DistanceLimit) & (linePlot_data$rt < rtLimit) & (linePlot_data$AbsZTargPoinDis <= StandDistance)),]
