...
linePlot_data <- linePlot_data[which((linePlot_data$target == 4) & (linePlot_data$bounType == 1) & (linePlot_data$TargPoinDis < DistanceLimit) & (linePlot_data$rt < rtLimit) & (linePlot_data$AbsZTargPoinDis <= StandDistance)),]
...
ggsave("2022-02-11-Target Wc in Rectangle.png",width = 10, height = 7, unit = "cm", dpi=300) 
